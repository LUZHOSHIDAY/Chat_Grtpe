...
from keras.optimizers.schedules import ExponentialDecay  # Corregido aquí
import random

# Carga de los datos de intenciones
data_file = open('intents_spanish.json', 'r', encoding='utf-8').read()  # Corregido 'utf_8' a 'utf-8'
...
for doc in documents:
    ...
    output_row[classes.index(doc[1])] = 1  # Corregido para asignar 1 en la posición correcta

    training.append([bag, output_row])

# Mezcla aleatoriamente el conjunto de entrenamiento en características (train_x) y etiquetas (train_y)
...
# Guarda el modelo de entrenamiento en un archivo h5
